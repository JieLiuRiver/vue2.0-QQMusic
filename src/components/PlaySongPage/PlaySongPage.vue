        ...
        <div class="item">
            <div class="song-info f-pr">
              <span class="singer-pic f-pr">
                <img src="https://y.gtimg.cn/music/photo_new/T002R150x150M000002Jy7u74gU4a8.jpg?max_age=2592000" width="100%" height="100%">
              </span>
            ...
            <div class="lyric-wrapper f-pr f-w" :style="{'height': lyricHeight + 'px'}">
              <div class="lyric f-pa f-w">
                  <div class="box f-w f-pr">
                    <div class="box-len f-pa f-w" :style="lyricAnimate" @touchstart="touchStart" @touchend="touchEnd" @touchmove="touchMove">
                      <div class="item" v-for="(item, index) in 100">
                        <p class="" :class="{'current': index == 2}">话好像还没说完- {{index + 1}}</p>
                      </div>
                    </div>
                  </div>
              </div>
  ...
  export default{
    ...
    data() {
      return {
        ...
        computedTimer: null,
        lyricHeight: (() => {
            return screen.height - HEIGHT2 - 112
        })(),
        restScreenHeight: (() => {
          return screen.height - HEIGHT2
        })(),
        swiperOption: {
          direction: 'vertical',
          spaceBetween: true,
